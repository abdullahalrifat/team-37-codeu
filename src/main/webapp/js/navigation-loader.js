  ...
  fetch('/login-status')
      ...
      .then((loginStatus) => {
        if (loginStatus.isLoggedIn) {
			...
			navigationElement.appendChild(
				createListItem(createLink('/timeline.html', 'Timeline')));

			navigationElement.appendChild(
				createListItem(createLink('/travelMates.html', 'Mates')));

			navigationElement.appendChild(
				createListItem(createLink('/chart.html', 'Trending')));
			...
			navigationElement.appendChild(
				createListItem(createLink('/aboutus.html', 'About')));
